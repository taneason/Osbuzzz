...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2025 at 12:07 AM
...
(1, 2, 'home', 'tan', 'ea', '', 'asdad', '', 'setapak', 'WP_LBN', '123456', 'Malaysia', '60177438690', 1, '2025-09-03 09:23:57', '2025-09-12 22:07:04'),
(2, 3, 'Checkout Address Sep 11, 2025', 'Tan', 'Ea Son', '', 'dfsdfdsf', '', 'sfdfs', 'WP_LBN', 'fsdf', 'Malaysia', '012-345-6789', 0, '2025-09-10 16:39:54', '2025-09-12 22:07:10');
...
--
ALTER TABLE `product_variants`
  MODIFY `variant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=254;
